...
const getPublicContent = async (req, res) => {
  try {
    ...
    const about = {
      title: "LUXURY AND PRECISION",
      description: "Established as a high-end design house in Munich, Germany, SIGNATURE represents the pinnacle of custom interior millwork..."
    };
